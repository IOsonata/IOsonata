...
@brief	Direct nRF54 CRACEN hardware crypto provider.
		...
		Register level driver for the nRF54 CRACEN block, independent of any
		host stack. Serves both the SDC and BM nRF54 library projects.
...
#error "crypto_cracen.cpp is only for nRF54 targets"
#endif
