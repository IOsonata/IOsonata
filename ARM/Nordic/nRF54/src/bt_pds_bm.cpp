...
public:
	...
	// RRAM is word rewritable: the physical program and erase unit is one
	...
	uint32_t EraseSize(void) const override { return BT_PDS_BM_WRITE_GRAN; }
	uint32_t WriteGran(void) const override { return BT_PDS_BM_WRITE_GRAN; }
	uint32_t LogicalSectorSize(void) const override { return BT_PDS_BM_SECTOR_SIZE; }
