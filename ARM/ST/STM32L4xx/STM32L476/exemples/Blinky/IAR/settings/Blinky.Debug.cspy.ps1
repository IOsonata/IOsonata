...
{
& "C:\Program Files (x86)\IAR Systems\Embedded Workbench 8.3\common\bin\cspybat" -f "Z:\swdev\IOsonata\ARM\ST\STM32L4xx\STM32L476\exemples\Blinky\IAR\settings\Blinky.Debug.general.xcl" --debug_file=$debugfile --backend -f "Z:\swdev\IOsonata\ARM\ST\STM32L4xx\STM32L476\exemples\Blinky\IAR\settings\Blinky.Debug.driver.xcl" 
}
